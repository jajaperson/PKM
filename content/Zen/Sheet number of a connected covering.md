...
Then the **sheet number**, i.e. the size of fibres $\abs{p^{-1}\{ x \}}$, is given by the [[Lagrange's theorem|subgroup index]] of the [[Characteristic subgroup of a covering|characteristic subgroup]] of $p$ in the [[fundamental group]][^loose] #m/thm/homotopy 
$$
\begin{align*}
