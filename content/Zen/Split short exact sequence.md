...
$$
\begin{align*}
0 \to A \stackrel f \hookrightarrow B \stackrel g \twoheadrightarrow C \to 0
\end{align*}
$$

A **split short exact sequence**[^spaltet] is a [[short exact sequence]] (depicted above) in an [[Abelian category]] 
...
[^spaltet]: German _spaltete kurze exakte Sequenz_
