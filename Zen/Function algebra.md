...
The **function algebra** $\mathbb{K}^X = \Set(X,\mathbb{K})$ consists of functions $X \to \mathbb{K}$ with scaling, addition, and multiplication defined pointwise. #m/def/ralg
