...
<dfn>Free modules</dfn> are the [[Free-forgetful adjunction|free objects]] in [[Category of left modules]]. #m/def/module 
Departing from classical tradition, we call a module equipped with an isomorphism from a free module a <dfn>framed module</dfn>,
while a module for which there [[mere existence|merely exists]] such an isomorphism is a <dfn>framable module</dfn>.
