...
- In a [[Path connectedness|path-connected]] space null-homotopic maps form a single [[Homotopy of continuous maps|homotopy class]] denoted $0$, since $0 \circ [f] = [f] \circ 0 = 0$.
