...
**Judgemental equality** is equality defined as a judgement, in contrast to [[Propositional equality|propositional]] or [[typal equality]].
...
[^1]: We depart from the usual convention: Type-theoretic literature will usually reserve $(=)$ for [[typal equality]], using either $(\equiv)$ or $(\dot{=})$ for judgemental equality. We take the opposite approach, which is more akin to the notation used in proof assistants. This is also used in [[@angiuliPrinciplesDependentType2025|Principles of dependent type theory]].
