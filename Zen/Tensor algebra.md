...
The **tensor algebra** $T^•V$ of a [[vector space]] $V$ is the [[Direct sum of vector spaces|direct sum]] of all [[Tensor product of vector spaces over a field|tensor powers]] of $V$ together with the outer product $(\otimes) : T^•V \times T^•V \to T^•V$, #m/def/ralg 
